...
let quizCSData: [QuizCSQuestion] = [

        QuizCSQuestion(question: "What is the main objective of the Mirage A Execution?",
        ...
        QuizCSQuestion(question: "Which Smokes are necessary for this execution?",
                     options: ["Jungle, CT, Stairs", "B Short, Window, Mid", "B Apps, Market, Van", "No Smokes are needed"],
                     correctAnswer: "Jungle, CT, Stairs"),

        QuizCSQuestion(question: "What is the purpose of the Flashbangs in this strategy?",
        ...
        QuizCSQuestion(question: "Where should the Molotov be placed?",
                     options: ["CT Spawn", "Default (common plant spot)", "Mid Window", "Jungle"],
                     correctAnswer: "Default (common plant spot)"),

        QuizCSQuestion(question: "What is the best post-plant setup for this tactic?",
        ...
        QuizCSQuestion(question: "Why do you need a player in Palace?",
        ...
        QuizCSQuestion(question: "Which weapon is best for holding Ramp after the bomb is planted?",
                     options: ["AWP", "P90", "Glock", "Nova"],
                     correctAnswer: "AWP"),

        QuizCSQuestion(question: "What should the Mid player do in this tactic?",
        ...
        QuizCSQuestion(question: "Which situation would make this tactic ineffective?",
        ...
        QuizCSQuestion(question: "What is a common mistake while executing this tactic?",
        ...
        QuizCSQuestion(question: "What is the main goal of this tactic?",
        ...
        QuizCSQuestion(question: "Which Smokes are required for a successful Mid split?",
        ...
        QuizCSQuestion(question: "Why do two players push from B Apartments?",
        ...
        QuizCSQuestion(question: "What is the primary role of the Mid player who moves through Underpass?",
        ...
        QuizCSQuestion(question: "What utility should be used to block CT rotations?",
        ...
        QuizCSQuestion(question: "Where should a Molotov be placed to disrupt CT defenders?",
                     options: ["Catwalk", "Market", "Van", "Apartments"],
                     correctAnswer: "Van"),

        QuizCSQuestion(question: "What is a common mistake while executing this strategy?",
        ...
        QuizCSQuestion(question: "How can the CTs counter this tactic?",
        ...
        QuizCSQuestion(question: "Why is this tactic stronger than a normal B rush?",
        ...
        QuizCSQuestion(question: "Where should the bomb be planted for a strong post-plant?",
